...
_INSTRUCTIONS = {
    ...
    "cold_1": (
        ...
        "{name} esta guardada esperando — se ela quiser que voce mande pra ele se "
        "emocionar ainda hoje, e so chamar. Curto."
    ),
    "cold_2": (
        "E a manha do dia seguinte. De bom dia com carinho e diga que voce nao para "
        "de pensar no que ela contou sobre {name}; a musica carrega isso e seria uma "
        "pena ele nunca chegar a ouvir. Sem pressao dura. Curto."
    ),
    "cold_3": (
